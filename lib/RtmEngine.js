...
class RtmEngine {
    ...
    /**
     * supports platform: ios, android
     * This method enables you set channel attributes by channel id.
     * @param channelId string.
     * @param attributeName string.
     * @param attributeValue string.
     * @return Promise
     */
    setChannelAttributeByChannelId(channelId, attributeName, attributeValue) {
        return setChannelAttributeByChannelId(channelId, attributeName, attributeValue);
    }
    /**
     * supports platform: ios, android
